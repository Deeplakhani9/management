...
class manager1 extends StatefulWidget {
  const manager1({Key? key}) : super(key: key);

  @override
  State<manager1> createState() => _manager1State();
}

class _manager1State extends State<manager1> {
  List data = [];
